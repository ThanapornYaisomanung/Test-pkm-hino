...
export default function ViewTruckType(props: any) {
    ...
    return (
        <div className="md:pt-8 md:pl-8 p-4 max-w-[1680px] w-full min-h-screen">
            ...
            <div className="text header">
                ...
                <p className="test-2xl md:text-3xl font-bold">รายละเอียดข้อมูลประเภทรถ</p>
                ...
                <div className=" bg-cyan-50  w-full p-8 shadow-md rounded-2xl  ">
                    ...
                    <div className="gap-4">
                        <div className="flex gap-4 max-md:w-full ">
                            <p className="max-w-24 md:w-32 w-full font-bold">ชื่อประเภทรถ:</p>
                            <p>{items.type_t_name}</p>

                        </div>


                        <div className="flex gap-4 max-md:w-full">
                            <p className="max-w-24 md:w-32 w-full font-bold">ชื่อ code:</p>
                            <p>{items.type_t_code}</p>
                        </div>
                    ...
                    {role === "admin" ? <div className="flex flex-wrap gap-8 pt-5 justify-center ">
                        <button className="flex" onClick={() => dbEdit(DataID)} ><Edit_icon /> Edit</button>
                        <button className="flex max-xl:hidden" onClick={() => handleDelete(DataID)} ><Delete_icon /> Delete</button>
