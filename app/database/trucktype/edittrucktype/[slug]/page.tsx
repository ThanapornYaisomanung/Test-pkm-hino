...
export default function Edittrucktype(props: any) {
    ...
    async function functionSave() {
        ...
        if (confirmBox == true) {
            alert("บันทึกสำเร็จ")
            try {
                const SwapUpdateRef = doc(db, "TruckType", DataID);

                // ชื่อรุ่น
                if (typeName === "undefined" || typeName === "") {
                    await updateDoc(SwapUpdateRef, {
                        type_t_name: items.type_t_name,
                    });
                } else {
                    await updateDoc(SwapUpdateRef, {
    ...
    return (
        <div className="md:pt-8 md:pl-8 p-4 max-w-[1680px] w-full min-h-screen">
            ...
            <div className="text header">
                ...
                <p className="text-2xl md:text-3xl font-bold">แก้ไขข้อมูลประเภทรถ</p>
